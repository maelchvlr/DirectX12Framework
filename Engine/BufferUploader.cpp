...
namespace Engine
{
	...
	void BufferUploader::Upload(D12Ressource* pDestination, void* pSourceData, const UINT size, D12CommandList* pCommandList, D12CommandQueue* pCommandQueue, D3D12_RESOURCE_STATES customState)
	{
		ENGINE_ASSERT(size < mMaxSize, "BufferUploader::Upload: Size of data is bigger than the allocated memory.");
